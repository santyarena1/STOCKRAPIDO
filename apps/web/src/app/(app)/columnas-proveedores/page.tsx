...
type FieldSuggestion = { field: string; columnPath: string | null; confidence: 'alta' | 'media' | 'baja' | null; auto?: boolean; candidates: Array<{ columnPath: string; confidence: string; score: number }> };
