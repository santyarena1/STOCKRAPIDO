...
function TabPaisesPrecios() {
  ...
  if (loading) return <FigLoading label="Países" />;
...
function TabCatalogo() {
  ...
  if (loading) return <FigLoading label="Catálogo" />;
